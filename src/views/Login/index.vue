<script setup>
import { regUserAPI } from '@/apis/user.js'
...
const rules = {
    username: [
        ...
        { min: 2, max: 12, message: '用户名必须是 2~12位 的字符', trigger: 'blur' }
    ],
    password: [
...
const register = async () => {
    ...
    console.log('发送的用户名和密码:', username, password);
    const res = await regUserAPI({ username, password })
    console.log(res)
